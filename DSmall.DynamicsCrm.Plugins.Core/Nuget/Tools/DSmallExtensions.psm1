...
function DSmallPrivate-UninstallImports($package) {
    $project = Get-Project
    $packageId = 'DSmall.DynamicsCrm.Plugins.Core'
...
function Uninstall-DSmall($package) {
    ...
    DSmallPrivate-UninstallImports($package)
...
Export-ModuleMember DSmallPrivate-UninstallImports
